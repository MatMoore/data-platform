...
Unit tests are implemented per container using pytest. We use [moto](https://pypi.org/project/moto/) to mock out AWS services.
...
follow the instructions in [Testing AWS base images](https://docs.aws.amazon.com/lambda/latest/dg/images-test.html#images-test-AWSbase).
